...
export function init(container, width = 600, height = 200) {
    ...
    // neutral horizontal center line
    svg
        .append('line')
...
function render(history) {
    ...
    if (!viz.svg || !viz.xScale || !viz.yScale || !viz.path || !viz.line || !viz.point)
        return;
    // keep x-domain dynamic based on history length (show up to 200 steps)
    const maxT = Math.max(200, history.length);
    if (viz.xScale)
        viz.xScale.domain([Math.max(0, ((_a = history[history.length - 1]) === null || _a === void 0 ? void 0 : _a.t) - 199 || 0), Math.max(200, ((_b = history[history.length - 1]) === null || _b === void 0 ? void 0 : _b.t) || 200)]);
...
//# sourceMappingURL=viz-toy7.js.map