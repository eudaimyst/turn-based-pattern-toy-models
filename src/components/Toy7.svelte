    ...
    <section class="toy-description">
      <p>
        This toy models the scalar recurrence <code
          >x[t+1] = (1 − S) * u[t] + S * x[t]</code
        >. Adjust <strong>S</strong> (saturation) and the external input
        <strong>u</strong> to observe how increased saturation reduces sensitivity
        to new inputs. The visualization shows the scalar state over discrete time
        steps.
      </p>
    </section>
