...
- **`BACKGROUND.md`** — Rationale, origins, and project context.  
- **`ETHICS.md`** — Safety boundaries, non-claims, usage constraints.  
- **`FUNDAMENTALS.md`** — Core mathematical foundations used throughout the project.  
- **`NON-LINEARITY.md`** — Notes on where and why nonlinearities are used.  
- **`CLARITY.md`** — Rationale for terminology choices to avoid misinterpretation.  
...
Additional files (e.g., `FAQ.md`, `AUDIENCE.md`) provide contextual framing and safety clarifications.
